...
$expid_drop_asset = "1";
if (isset($HTTP_SESSION_VARS['experiment_id'])) {
  $expid_drop_asset = (get_magic_quotes_gpc()) ? $HTTP_SESSION_VARS['experiment_id'] : addslashes($HTTP_SESSION_VARS['experiment_id']);
}
mysql_select_db($database_CAPM, $CAPM);
...
mysql_select_db($database_CAPM, $CAPM);
$query_M_detail = "SELECT market.price, market.Qd, market.Qs, market.Ed FROM market WHERE market.round_id = $rid AND market.asset_id = $aid";
              ...
              <tr>
                <td valign="top"><span class="redtitles">
                  <div align="right"><!-- InstanceBeginEditable name="Description" --> 
                    Student:Results<!-- InstanceEndEditable --></div>
                  </span></td>
              </tr>
              <tr>
...
<TD ALIGN=center><?php echo $row_summary['price']; ?></TD>
</TABLE>
 <BR>
...
<TD><?php echo $row_M_detail['price']; ?></TD>
