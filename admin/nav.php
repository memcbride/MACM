...
<table width="140" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td> 
			<a href="../admin/status_admin.php" class="Snav">Status</a><BR>
            <a href="../admin/users.php" class="Snav">Users</a><BR>
            <a href="../admin/user_states.php" class="Snav">User States</a><BR>
            <a href="../admin/rounds.php" class="Snav">Rounds</a><BR>
			<a href="../orders.php" class="Snav">Orders</a><BR>
			<a href="../results.php" class="Snav">View Results</a><BR>
			<a href="../track_student.php" class="Snav">Track Student</a><BR>
